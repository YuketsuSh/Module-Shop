    ...
    <div class="max-w-2xl mx-auto" x-data="tagForm()" x-init="init()">
        <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
            <div class="flex flex-col space-y-1.5 p-6">
                <h3 class="text-2xl font-semibold leading-none tracking-tight">Créer un nouveau tag</h3>
            </div>

            <div class="p-6 pt-0">
                <form method="POST" action="{{ route('admin.shop.tags.store') }}" class="space-y-6">
                    @csrf
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="name" id="name"
                               value="{{ old('name') }}"
                               placeholder="Ex : Populaire, Promo, Nouveauté..."
