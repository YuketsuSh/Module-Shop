    ...
    <div class="max-w-2xl mx-auto" x-data="categoryForm()" x-init="init()">
        <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
            <div class="flex flex-col space-y-1.5 p-6">
                <h3 class="text-2xl font-semibold leading-none tracking-tight">Modifier la catégorie</h3>
            </div>

            <div class="p-6 pt-0">
                <form method="POST" action="{{ route('admin.shop.categories.update', $category) }}" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="description" id="description" rows="4"
                                  ...
                                  placeholder="Brève description de la catégorie...">{{ old('description', $category->description) }}</textarea>
            ...
            Alpine.data('categoryForm', () => ({
                init() {
                    ...
                    nameInput?.addEventListener('input', () => {
                        if (!slugInput.dataset.changed || slugInput.dataset.changed === 'false') {
